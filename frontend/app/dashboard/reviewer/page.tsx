    ...
    <DashboardShell active="02">
      <main className="dash-main">
        ...
        <div className="dashboard-grid">
          ...
          <StatePanel
            kind="empty"
            title="No review queue is available"
            detail="The backend does not provide a queue, assignment, or history endpoint. A known research ID must be supplied outside this application."
          />
        </div>
      </main>
    </DashboardShell>
