...
export default async function AdminResearchPage() {
  ...
  return <main className="admin-main"><header className="admin-page-heading admin-heading-actions"><div><p>Research Archive <span>ระบบจัดการข้อมูล</span></p><h1>จัดการผลงานวิจัย</h1></div><div><Link className="admin-primary-action" href="/student/research/new"><Plus size={17} />เพิ่มผลงานวิจัยใหม่</Link><button className="admin-secondary-action" type="button" disabled title="Backend ยังไม่มี Export endpoint"><Download size={17} />Export</button></div></header><AdminResearchManager records={records} /></main>;
}
